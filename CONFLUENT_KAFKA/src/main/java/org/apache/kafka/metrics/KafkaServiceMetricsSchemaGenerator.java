...
public class KafkaServiceMetricsSchemaGenerator extends AbstractCodahaleFixtureGenerator {
    ...
    private static final String SERVICE_NAME = "CONFLUENTKAFKA";

    private static final String KAFKA_BROKER = "CONFLUENTKAFKA_BROKER";
    private static final String KAFKA_BROKER_TOPIC = "CONFLUENTKAFKA_BROKER_TOPIC";
    private static final String KAFKA_REPLICA = "CONFLUENTKAFKA_REPLICA";
